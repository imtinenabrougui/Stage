...
use App\Repository_ReclamationRepository;
...
class ReclamationController extends AbstractController
{
    ...
    #[Route('/afficherback', name: 'app_reclamation_back', methods: ['GET'])]
    ...
    public function show(int $idr, EntityManagerInterface $entityManager): Response
    {
    ...
    public function edit(Request $request, int $idr, EntityManagerInterface $entityManager): Response
    {
        $reclamation = $entityManager
            ->getRepository(Reclamation::class)
            ->find($idr);
    ...
    public function delete(Request $request, int $idr, EntityManagerInterface $entityManager): Response
    {
        $reclamation = $entityManager
            ->getRepository(Reclamation::class)
            ->find($idr);
